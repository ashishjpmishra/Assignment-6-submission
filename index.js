...
for(var i=0; i<cards.length; i++){
    ...
    mainGrid.classList.add("gridItem");
    ...
    innerGrid.classList.add("cardContent");
    mainCard.appendChild(innerGrid);

    var headLine = document.createElement('h1')
    headLine.classList.add("cardHeader");
    headLine.innerText = cards[i].imgAlt;
    innerGrid.appendChild(headLine);

    var paragraph = document.createElement('p')
    paragraph.classList.add("cardText");
    paragraph.innerText = cards[i].description ;
    innerGrid.appendChild(paragraph);

    //appending all section to the outermostgrid 

    var outerMostGrid = document.getElementById("grid");
    outerMostGrid.appendChild(mainGrid);
    //console.log(outerMostGrid)
    }
